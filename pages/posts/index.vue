<template>
    <div class="container mx-auto px-4 py-8">
        ...
        <div v-else class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div v-for="post in posts.data" :key="post.id" class="bg-white rounded-lg overflow-hidden shadow-md transition-shadow hover:shadow-lg">
                <div class="p-6">
                    ...
                    <NuxtLink :to="`/posts/${post.slug}`" class="inline-block bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-md transition-colors">
                        Read More
                    </NuxtLink>
                </div>
            </div>
